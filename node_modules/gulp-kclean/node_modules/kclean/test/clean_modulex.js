modulex.add("m/a", ["xtemplate/runtime","util","event-dom/gesture/tap","node","component/control","gregorian-calendar-format","gregorian-calendar","i18n!date-picker","component/extension/shim","component/extension/align"], function(require, exports, module) {
...
date_picker_xtpl_decades = function (exports) {
  exports = function decades(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_years = function (exports) {
  exports = function years(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_year_panel = function (exports) {
  exports = function yearPanel(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_months = function (exports) {
  exports = function months(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_month_panel = function (exports) {
  exports = function monthPanel(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_picker = function (exports) {
  exports = function picker(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_popup = function (exports) {
  exports = function popup(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
...
date_picker_xtpl_decade_panel = function (exports) {
  exports = function decadePanel(undefined) {
    var t;
    var t0;
    var t1;
    var t2;
